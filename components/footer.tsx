...
import { FaFacebookF, FaGithub, FaTwitter, FaPinterest, FaInstagram } from "react-icons/fa";
...
export const Footer = ({ data, icon, rawData }) => {
  ...
  return (
        ...
        <div className="flex-wrap p-3 text-center parallax-footer justify-content-center">
          <div className="py-4 m-1 bg-stone-600 lg:mx-80">
        ...
        <div className="text-center bg-stone-600">
          <small className="text-xs text-white">Copyright © 2022</small>
        </div>
      </footer>
